<x-vendor-master-layout :pageTitle="$pageTitle">
    ...
    <div class="tab-content">
        <div class="tab-pane  @if (!$errors->has('gallery_image_url')) active @endif" id="details" role="tabpanel">
            <x-form-base :route="'vendor.products.update'" :requiredParam="$product" :title="$pageTitle"
        ...
        <div class="tab-pane @if ($errors->has('gallery_image_url')) active @endif" id="gallery" role="tabpanel">
            ...
            <x-form-base :route="'vendor.products.gallery.update'" :requiredParam="$product" :method="'PUT'"
        ...
        <script>
            $(document).ready(function() {
                ...
                $("body").on("click", "#deleteGallery", function(e) {
                    ...
                    var id = $(this).data("id");
                    var url = "{{ route('vendor.products.gallery.destroy', '') }}/" + id;
