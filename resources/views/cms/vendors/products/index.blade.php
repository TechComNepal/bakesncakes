        ...
        <script>
            function toggleIsTaxable(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('vendor.products.toggle.taxable') }}",
                    data: {
            ...
            function toggleIsFeatured(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('vendor.products.toggle.featured') }}",
                    data: {
            ...
            function toggleIsRefundable(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('vendor.products.toggle.refundable') }}",
                    data: {
            ...
            function toggleIsTrending(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('vendor.products.toggle.trending') }}",
                    data: {
            ...
            function toggleIsSellable(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('vendor.products.toggle.sellable') }}",
                    data: {
            ...
            $(document).ready(() => {
                ...
                $('#datatable').on('click', '#delete-btn', function(event) {
                    ...
                    var id = $(this).data('id');
                    var delete_url = "{{ route('vendor.products.destroy', '') }}/" + id;
