<x-vendor-master-layout :pageTitle="$pageTitle">
    ...
    <x-form-base :route="'vendor.products.store'" :title="$pageTitle" :subTitle="$subTitle" class="bg-soft-light">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <x-input-field :type="'number'" :label="'Minimum Purchase Unit'" :name="'min_purchase_unit'"
                            :placeholder="'Please enter Minimum Purchase Unit here.'" :required="true" :autofocus="true"
                            :step="1" />
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <x-input-field :type="'number'" :label="'Cost Price'" :name="'cost_price'"
                                :placeholder="'Please enter Cost Price here.'" :required="true" :autofocus="true"
                                :step="0.01" :col="'6'" />

                            <!-- Selling Price -->
                            <x-input-field :type="'number'" :label="'Selling Price'" :name="'selling_price'"
                                :placeholder="'Please enter Selling Price here.'" :required="true" :autofocus="true"
                                :step="0.01" :col="'6'" />
                            ...
                            <x-select-field-name :label="'Discount Type'" :name="'discount_type'"
                                ...
                                <option value="flat" @if (old('discount_type') == 'flat') selected @endif>Flat</option>
                                <option value="percent" @if (old('discount_type') == 'percent') selected @endif>Percent
                                </option>
                            </x-select-field-name>
