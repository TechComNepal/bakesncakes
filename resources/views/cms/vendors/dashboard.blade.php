<x-vendor-master-layout :pageTitle="'Dashboard'">
        ...
        <div class="col-xl-4 col-md-6">
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Subscription</span>
                            <h4 class="mb-3">
                                <span class="counter-value"
                                    data-target="{{ $total_subscription }}">{{ $total_subscription }}</span>
                            </h4>
                        </div>
                    </div>
                    <div class="text-nowrap">
