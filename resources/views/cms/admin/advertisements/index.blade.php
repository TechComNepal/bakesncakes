            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="ms-auto">
                            <div>
                                <a href="{{ route('admin.advertisements.create') }}" type="button"
        ...
        <script>
            function toggleIsStatus(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('admin.advertisements.toggle.status') }}",
                    data: {
                        'is_status': is_status,
                        'advertisement_id': id,
                    },
            ...
            $(document).ready(() => {
                ...
                var DTable = $("#datatable").DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'advertisement_placement_id',
                            name: 'advertisement_placement_id'
                        },
                        {
                            data: 'status',
                            name: 'status'
                ...
                $('#datatable').on('click', '#delete-btn', function(event) {
                    ...
                    var id = $(this).data('id');
                    var delete_url = "{{ route('admin.advertisements.destroy', '') }}/" + id;
