                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-9 mt-5">
                                <ul class="nav nav-pills mb-4" id="tabMenu" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link nav-profile-link @if ($errors->has('current_password') || $errors->has('password') || $errors->has('confirm_password')) active @endif"
                                            id="pills-security-tab" data-bs-toggle="pill" href="#pills-security"
                                            role="tab" aria-controls="pills-security" aria-selected="false">Security</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link nav-profile-link" id="pills-address-tab"
                                            data-bs-toggle="pill" href="#pills-address" role="tab"
                                            aria-controls="pills-address" aria-selected="false">Address</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade  @if (!$errors->has('current_password') && !$errors->has('password') && !$errors->has('confirm_password')) show active @endif"
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body bio-graph-info">
                                                <form action="{{ route('user.profiles.update', $user) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'Name'" :name="'name'"
                                                                :placeholder="'Please enter user name here.'" :required="true" :autofocus="true"
                                                                :value="$user->name" />
                                                        </div>
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'UserName'" :name="'username'"
                                                                :placeholder="'Please enter user username here.'" :required="true" :autofocus="true"
                                                                :value="$user->username" />
                                                        </div>
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'Email'" :name="'email'"
                                                                :placeholder="'Please enter email here.'" :required="true" :autofocus="true"
                                                                :value="$user->email" />
                                                        </div>
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'Phone'" :name="'phone'"
                                                                :placeholder="'Please enter phone no.'" :required="true" :autofocus="true"
                                                                :value="$user->phone" />
                                                        </div>
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'City'" :name="'city'"
                                                                :placeholder="'Please enter city here.'" :required="true" :autofocus="true"
                                                                :value="$user->city" />
                                                        </div>
                                                        <div class="bio-row col-12 col-md-6">
                                                            <x-input-field :label="'Address'" :name="'address'"
                                                                :placeholder="'Please address here.'" :required="true" :autofocus="true"
                                                                :value="$user->address" />
                                                        </div>
                                    ...
                                    <div class="tab-pane fade @if ($errors->has('current_password') || $errors->has('password') || $errors->has('confirm_password')) show active @endif"
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body bio-graph-info">
                                                <form action="{{ route('user.profiles.change.password') }}"
                                                    method="POST" enctype="multipart/form-data"
                                                    class="needs-validation">
                                                    @csrf
                                                                ...
                                                                <div class="row">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        <span class="d-flex p-3">
                                                                                            <span
                                                                                                class="flex-shrink-0 mt-1"></span>
                                                                                            <span
                                                                                                class="flex-grow-1 pl-3 text-left">
                                                                                                <div>
                                                                                                    <span
                                                                                                        style="opacity: 0.6">Delivery
                                                                                                        Address:</span>
                                                                                                    <span
                                                                                                        class="ml-2"
                                                                    ...
                                                                    <div class="col-md-6 mx-auto mb-3">
                                                                        <div class="border p-3 rounded mb-3 c-pointer text-center bg-white h-100 d-flex flex-column justify-content-center"
                                                                            ...
                                                                            <div class="alpha-7">Add New Address
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <form action="{{ route('user.shipping.address') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <x-input-field :label="'Name'" :name="'name'" :id="'address_name'"
                                    :required="true" :placeholder="'Name Here'" :col="'6'" />
