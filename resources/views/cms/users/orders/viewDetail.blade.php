                                ...
                                <div class="d-flex justify-content-center row">
                                    <div class="col-md-12">
                                        <div class="receipt bg-white p-5 rounded">
                                            <h4 class="mt-2 mb-3">Your order is {{ ucfirst($order->status) }}!
                                            </h4>
                                            ...
                                            <div
                                                ...
                                                <div><span class="d-block fs-12">Order number</span><span
                                                        class="font-weight-bold">{{ $order->order_code }}</span></div>
                                                <div><span class="d-block fs-12">Payment method</span><span
                                                        class="font-weight-bold">{{ $order->payment_method }}</span>
                                                </div>
                                                <div><span class="d-block fs-12">Delivery Address</span><span
                                                ...
                                                <div class="col-md-6">
                                                    <div class="billing">
                                                        ...
                                                        <div class="d-flex justify-content-between mt-2"><span>Discount
                                                                Amount</span><span class="font-weight-bold">Rs
                                                                {{ $order->coupon_discount }}</span></div>
                                                        <div class="d-flex justify-content-between mt-2"><span>Subtotal
                                                                after
                                                                discount</span><span class="font-weight-bold">Rs
                                                                {{ $order->billing_total - $order->delivery_charge - $total_tax }}
                                                            </span>
                                                        </div>
                                                        <div class="d-flex justify-content-between mt-2"><span>Tax
                                                                Amount
                                            ...
                                            <div class="d-flex justify-content-between align-items-center footer">
                                                ...
                                                <div class="d-flex flex-column justify-content-end align-items-end">
                                                    <span class="d-block font-weight-bold">Need Help?</span><span>Call -
