                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-card-bottom">
                                            ...
                                            <div class="product-price">
                                                <span>
                                                    Rs.{{ $featured_product->selling_price * (1 -
                                            ...
                                            <div class="product-price">
                                                <span>
                                                    Rs.
                                                    {{ $featured_product->selling_price - $featured_product->discount
                                                    }}</span>
                            ...
                            <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="deals-content">
                                        ...
                                        <div>
                                            <span class="font-small text-muted">By: <a href="vendor-details-1.html">{{
                                                    $trending_product->user->name }}</a></span>
                                        </div>
                                        <div class="product-card-bottom">
                                            ...
                                            <div class="product-price">
                                                <span>
                                                    Rs.{{ $trending_product->selling_price * (1 -
                                                    $trending_product->discount / 100) }}</span>
                                            ...
                                            <div class="product-price">
                                                <span>
                                                    Rs.
                                                    {{ $trending_product->selling_price - $trending_product->discount
                                                    }}</span>
                                                <span class="old-price">Rs.{{ $trending_product->selling_price }}</span>
                                            </div>
                                            @endif
                ...
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        ...
                        <li wire:click="selectedCategory({{$category->id}})">
                            ...
                            {{$category->name}}</a><span class="count">{{$category->products->count()}}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="sidebar-widget price_range range mb-30">
                    ...
                    <div class="price-filter">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="caption">From: <strong id="price-slider-min" class="text-brand">Rs{{ $min_price
                                    }}</strong></div>
                            <div class="caption">To: <strong id="price-slider-max" class="text-brand">Rs{{ $max_price
                                    }}</strong></div>
                        </div>
