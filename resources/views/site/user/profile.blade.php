<x-site-master-layout>
    ...
    <style>
        ...
        .card-header {
            ...
            margin-bottom: 0;
            background-color: rgba(175, 48, 57, 0.09);
            border-bottom: 1px solid rgba(175, 48, 57, 0.125);
        }
    ...
    <div class="row profile-dashboard container col-lg-12">
        <div class="col-xl-3">
            ...
            <div class="card mb-4 mb-xl-0 profile-card">
                ...
                <div class="card-body text-center">
                    ...
                    <button class="btn ps-btn--address" type="button">Upload new image</button>
                </div>
            </div>
        </div>
        <div class="col-xl-9 profile-form">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <!-- Save changes button-->
                        <button class="btn btn-lg ps-btn--address" type="button">Save changes</button>
                    </form>
                </div>
            </div>
        </div>
