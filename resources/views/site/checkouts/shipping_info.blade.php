                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <x-input-field :label="'Name'" :name="'name'" :required="true" :placeholder="'Name Here'"
                                :col="'6'" />
                            <x-input-field :label="'Phone Number'" :name="'phone_no'" :required="true" :placeholder="'Phone Number Here'"
                                :col="'6'" />
                            <x-select-field :label="'Select City'" :name="'city_id'" :required="'TRUE'" :placeholder="'Select City'"
                                :col="'6'">
                            ...
                            <x-input-field :label="'Delivery Address'" :name="'delivery_address'" :required="true" :placeholder="'Delivery Address Here'"
                                :col="'6'" />
                            <x-input-field :label="'LandMark Address'" :name="'landmark'" :required="true" :placeholder="'LandMark Address Here'"
                                :col="'6'" />
