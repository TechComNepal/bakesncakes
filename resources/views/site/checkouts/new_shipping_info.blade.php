                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="border p-3 rounded mb-3 c-pointer bg-white h-100">
                                                <label class="d-block bg-white mb-0">
                                                    <input type="radio" name="address_id" value="{{ $address->id }}" style="height:20px; width:20px; vertical-align: middle;" data-charge="{{ $address->shipping->delivery_charge }}" @if ($address->set_default) checked @endif
                                                    required>
                                                    <span class="d-flex p-3">
                                                        <span class="flex-shrink-0 mt-1"></span>
                                                        <span class="flex-grow-1 pl-3 text-left">
                                                            <div class="d-flex flex-row justify-content-center">
                                                                <img src="{{asset('new_frontend/assets/imgs/delivery.jpg')}}" alt="delivery address" height="150px" width="150px">
                                                            </div>
                                                             <!--<div>
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                    <th scope="row">{{ $address->delivery_address }}</th>
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <a href="javascript:void(0)" type="button" class="btn btn-danger" data-bs-toggle="tooltip" title="Edit" style="margin-right: 5px;" onclick="edit_address('{{ $address->id }}')">
                                                        <i class="fa fa-edit"></i> Edit
                                                    </a>
                                                <a href="javascript:void(0)" id="delete-btn" data-id="{{ $address->id }}" data-bs-toggle="tooltip" title="Delete" data-bs-original-title="Delete" class="btn btn-outline-danger"> <i class="fa fa-trash pl-3 text-white bg-white" style="color: #fff;"></i>Delete</a>
                                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="ps-checkout__form">
                            ...
                            <a href="{{ route('site.page') }}" class="btn mb-20 w-100">Continue Shopping<i class="fi-rs-sign-out ml-15"></i></a>
