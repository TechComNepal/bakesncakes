                        ...
                        <div class="col-xl-10 col-lg-12 m-auto">
                            <section class="row align-items-center mb-50">
                                ...
                                <div class="col-lg-6">
                                    <div class="pl-25">
                                        ...
                                        <p class="mb-50">Ius ferri velit sanctus cu, sed at soleat accusata. Dictas
                                            prompta
                                            et Ut placerat legendos interpre.Donec vitae sapien ut libero venenatis
                                            faucibus. Nullam quis ante Etiam sit amet orci eget. Quis commodo odio
                                            aenean
                                            sed adipiscing. Turpis massa tincidunt dui ut ornare lectus. Auctor elit sed
                                            vulputate mi sit amet. Commodo consequat. Duis aute irure dolor in
                                            reprehenderit
                            ...
                            <section class="text-center mb-50">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-24">
                                        <div class="featured-card">
                                            <img src="assets\imgs\theme\icons\icon-4.svg" alt="">
                                            <h4>Easy Returns</h4>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the
                                                majority have suffered alteration in some form</p>
                                            <a href="#">Read more</a>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-24">
                                        <div class="featured-card">
                                            <img src="assets\imgs\theme\icons\icon-5.svg" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-24">
                                        <div class="featured-card">
                                            <img src="assets\imgs\theme\icons\icon-6.svg" alt="">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5">
                                        ...
                                        <p>Volutpat diam ut venenatis tellus in metus. Nec dui nunc mattis enim ut
                                            tellus
                                            eros donec ac odio orci ultrices in. ellus eros donec ac odio orci ultrices
                                            in.
                                        </p>
                                    </div>
                                    <div class="col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5">
                            ...
                            <section class="mb-50">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                        ...
                                        <p class="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam
                                                ...
                                                <div class="team-card">
                                                    ...
                                                    <div class="content text-center">
                                                        ...
                                                        <div class="social-network mt-20">
                                                            <a href="#"><img
                                                                    src="assets\imgs\theme\icons\icon-facebook-brand.svg"
                                                                    alt=""></a>
                                                            <a href="#"><img
                                                                    src="assets\imgs\theme\icons\icon-twitter-brand.svg"
                                                                    alt=""></a>
                                                            <a href="#"><img
                                                                    src="assets\imgs\theme\icons\icon-instagram-brand.svg"
                                                                    alt=""></a>
                                                            <a href="#"><img
                                                                    src="assets\imgs\theme\icons\icon-youtube-brand.svg"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
