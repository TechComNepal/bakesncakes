...
class BrandController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('cms.vendors.brands.create', compact('categories'));
    }
    ...
    public function store(BrandStoreRequest $request)
    {
        ...
        try {
            ...
            return $brand
                ? $this->responseRedirect('vendor.brands.index', 'Brand Created Successfully', 'success')
    ...
    public function edit(Brand $brand)
    {
        ...
        return view('cms.vendors.brands.edit', [
    ...
    public function update(Brand $brand, BrandUpdateRequest $request)
    {
        ...
        try {
            ...
            return $brand
                ? $this->responseRedirect('vendor.brands.index', 'Brand Updated Successfully', 'success')
    ...
    protected function datatable()
    {
        ...
        return DataTables::of($brands)
            ...
            ->addColumn('actions', function ($data) {
                ...
                if (auth()->user()->can('edit brand')) {
                    $button.= '<a
                        href="' .route('vendor.brands.edit', $data). '"
                            type="button"
