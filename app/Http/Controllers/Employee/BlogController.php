...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return request()->ajax()
            ? $this->datatable()
            : view('cms.employees.pages.blogs.index');
    }
    ...
    public function create()
    {
        ...
        return view('cms.employees.pages.blogs.create');
    }
    ...
    public function store(BlogStoreRequest $request, Blog $blog)
    {
        ...
        try {
            ...
            return $blog->create($merge->all())
                ? $this->responseRedirect('employee.blogs.index', 'Blog Successfully Created.', 'success')
    ...
    public function edit(Blog $blog)
    {
        ...
        return view('cms.employees.pages.blogs.edit', [
        ...
        try {
            ...
            if ($blog) {
                ...
                return $blog->update($merge->all())
                    ? $this->responseRedirect('employee.blogs.index', 'Blog created Sucessfully', 'success')
    ...
    protected function datatable()
    {
        ...
        return DataTables::of($data)
            ->addColumn('actions', function ($data) {
                ...
                if(auth()->user()->can('edit blog')){
                    $button .= '<a
                        href="' . route('employee.blogs.edit', $data) . '"
                            type="button"
