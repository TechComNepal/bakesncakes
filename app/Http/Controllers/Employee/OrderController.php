...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        return (request()->ajax())
            ...
            : view('cms.employees.orders.index');
    }
    ...
    public function show(Order $order)
    {
        ...
        return view('cms.employees.orders.show', compact('order'));
    }
    ...
    public function update(Request $request, Order $order)
    {
        ...
        return $this->responseRedirect('employee.orders.index', 'Order Status Updated Successfully.', 'success');
    }

    protected function datatable(Request $request)
    {
        if (Auth::user()->hasRole('vendor')) {
            $query = Order::where('seller_id', Auth::user()->id)->orderBy('updated_at', 'DESC');
        } else {
            $query = Order::latest();
        }
        ...
        return DataTables::of($orders)
            ...
            ->addColumn('actions', function ($data) {
                ...
                if (auth()->user()->can('view order')) {
                    $button.='<a
                    href="' . route('employee.orders.show', $data) . '"
                        type="button"
